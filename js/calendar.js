/**
* Arie Nugraha 2009
* Some modification by Drajat Hasan 2018
...
function openCalendar(strDatefieldID) {
  if (calendarPop) {
    ...
    // MOdification by Drajat Hasan
    $(document.body).append('<div style="width: 300px;" id="calendarPop">'
      + '<div style="float: left; width: 80%"><b>Calendar</b></div>'
      + '<div style="float: right; width: 20%; text-align: right;">'
      + '<a style="text-decoration: none;color: white; font-weight: bold; cursor: pointer;background-color: #ff312b;border-color: #d43f3a;border-radius: 13px; padding:7px;" onclick="calendarPop.hide()">Close</a>'
      + '</div>'
  ...
  calendarPop.css({'position': 'absolute', 'left': (dateFieldPos.left-2)+'px', 'top': (dateFieldPos.top-5)+'px'});
  //calendarPop.css({'position': 'absolute', 'left': (dateFieldPos.left-2)+'px', 'top': 'top': (dateFieldPos.top-2)+'px'}); // Modified by Drajat Hasan
