...
// senayan version
define('SENAYAN_VERSION', 'Setiadi 2 (Lukulo)');
...
$sysconf['authority_level'][2] = __('Dosen Pembimbing 1');
$sysconf['authority_level'][3] = __('Dosen Pembimbing 2');
$sysconf['authority_level'][4] = __('Ketua Penguji');
$sysconf['authority_level'][5] = __('Penguji 1');
$sysconf['authority_level'][6] = __('Penguji 2');
