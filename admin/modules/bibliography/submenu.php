...
$menu[] = array(__('ETD List'), MWB.'bibliography/index.php', __('Show Existing ETD Data'));
$menu[] = array(__('Add New ETD'), MWB.'bibliography/index.php?action=detail', __('Add New ETD Data/Catalog'));
