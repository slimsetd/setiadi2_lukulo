...
<fieldset class="menuBox adminHome">
  <div class="menuBoxInner">
      <div class="per_title" style="color: white; background: #3c8dbc !important;">
...
<div class="row">
    <div class="col-xs-6 col-md-3 col-lg-3">
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="s-widget-icon biblio"><i class="fa fa-bookmark"></i></div>
    ...
    <div class="col-xs-6 col-md-3 col-lg-3">
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="s-widget-icon item"><i class="fa fa-barcode"></i></div>
    ...
    <div class="col-xs-6 col-md-3 col-lg-3">
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="s-widget-icon lent"><i class="fa fa-archive"></i></div>
    ...
    <div class="col-xs-6 col-md-3 col-lg-3">
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="s-widget-icon avail"><i class="fa fa-check"></i></div>
