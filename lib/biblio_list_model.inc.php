    ...
    while ($_biblio_d = $this->resultset->fetch_assoc()) {
      ...
      if (!empty($_biblio_d['image']) && !defined('LIGHTWEIGHT_MODE')) {
        ...
        if ($sysconf['tg']['type'] == 'phpthumb') {
          $_image_cover = '<img class="thumb" src="./lib/phpthumb/phpThumb.php?src='.$sysconf['tg']['relative_url'].''.$images_loc.'&w=90" data-large-img-url="'.$images_loc.'"/>';
        } elseif ($sysconf['tg']['type'] == 'minigalnano') {
          $_image_cover = '<img class="thumb" src="./lib/minigalnano/createthumb.php?filename='.$sysconf['tg']['relative_url'].''.$images_loc.'&width=90" data-large-img-url="'.$images_loc.'"/>';
        } else {
          $_image_cover = '<img class="thumb" src="./lib/phpthumb/phpThumb.php?src='.$sysconf['tg']['relative_url'].''.$images_loc.'&w=90" data-large-img-url="'.$images_loc.'"/>';
        }
      }
      ...
      $_buffer .= '<div class="item"><div class="cover-list"><a class="magnifier-thumb-wrapper" href="#">'.$_image_cover.'</a></div>';
